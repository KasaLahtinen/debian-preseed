...
const PreseedForm = ({ data, onSubmit }) => {
    ...
    return (
        <form onSubmit={handleFormSubmit} className="preseed-form">
            ...
            <button type="submit" style={{ padding: '10px 20px', cursor: 'pointer', backgroundColor: '#2563eb', color: 'white', border: 'none', borderRadius: '6px' }}>Generate Configuration</button>
        </form>
    );
};
